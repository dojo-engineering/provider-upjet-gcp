...
func (mg *QueueIAMMember) ResolveReferences( // ResolveReferences of this QueueIAMMember.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("cloudtasks.gcp.upbound.io", "v1beta2", "Queue", "QueueList")
		if err != nil {
